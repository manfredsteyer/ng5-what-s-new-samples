...
var AuthChildGuard = /** @class */ (function () {
    function AuthChildGuard(authService, router) {
        this.authService = authService;
        this.router = router;
    }
    AuthChildGuard.prototype.canActivateChild = function (childRoute, state) {
...
export { AuthChildGuard };
//# sourceMappingURL=auth.child.guard.js.map